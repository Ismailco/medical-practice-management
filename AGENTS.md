...
- Prescription mutations must use dedicated draft create/save/discard, finalize, void, duplicate, and replacement operations. Never edit issued content or items, and never allocate a prescription number before finalization.
